            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="nav navbar-nav">
                       ...
                       <li class="nav-item"><a href="chatbot.php" class="nav-link">Support</a></li>
                       <?php
                          } 
                    ?>
                    </ul>
                ...
                if (isset($_SESSION['email'])) {
                    ...
                    ?>
                    <ul class="nav navbar-nav ml-auto">
                       <li class="nav-item "><a href="#signup" class="nav-link"data-toggle="modal" ><i class="fa fa-user"></i>User sign In</a></li>
                       <li class="nav-item "><a href="#login" class="nav-link" data-toggle="modal"><i class="fa fa-sign-in"></i>User Login</a></li>
                       <li class="nav-item "><a href="admin_login.php" class="nav-link"><i class="fa fa-user-shield"></i> Admin Login</a></li>
                    </ul>
                    <?php 
                }
                    ?>
